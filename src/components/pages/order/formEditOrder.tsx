...
const EditFormOrder: React.FC<EditFormOrderProps> = ({
  open,
  onClose,
  onSubmit,
  fetchServices,
  ...
  useEffect(() => {
    ...
    if (orderDetails) {
      ...
      setItems(orderDetails?.items?.map((item: any) => item.itemName));
